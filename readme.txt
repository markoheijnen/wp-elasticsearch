...
Donate link: https://www.searchbox.io
Tags: better search, lucene, elasticsearch
...
WP-Elasticsearch replaces the default Wordpress search with ElasticSearch.By moving to ElasticSearch you will be able to benefit from Lucene's capabilities which provides a more relevant search experience and you will reduce the load on your SQL server by avoiding the search on the database.
...
See: [Github Documentation] (http://searchbox-io.github.com/wp-elasticsearch/) for details. 
